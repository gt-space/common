use pyo3::{PyObject, IntoPy, Python};
...
impl IntoPy<PyObject> for Measurement {
	fn into_py(self, py: Python<'_>) -> PyObject {
		match self.unit {
			...
			Unit::Fahrenheit => Temperature::new(self.value).into_py(py),
